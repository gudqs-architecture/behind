...
public class ImageCodeUtil {
    ...
    public static Map<String, Object> getImageCode(int width, int height, int fontSize) {
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            g.drawString(str, 13 + (fontSize - 10) * i, fontSize - 3);
        }
        // 释放图形上下文
        g.dispose();
        returnMap.put("image", image);
        returnMap.put("code", strEnsure.toString());
        return returnMap;
    }
