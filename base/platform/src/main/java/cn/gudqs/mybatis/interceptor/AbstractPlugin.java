...
public abstract class AbstractPlugin implements IDialectPlugin {
    ...
    public void setPageTotalSql(Object oParams, BoundSql boundSql, Connection connection, MappedStatement mappedStatement) throws Throwable {
        ...
        if (gridParams.isPageMode()) {
            sbSql.append(boundSql.getSql()).append(" ");
        } else {
            String filterSql = this.appendFilterSql(gridParams.getFilter());
            if (filterSql != null) {
        ...
        dealPage(oParams, boundSql, connection, mappedStatement, pMap, sbSql.toString());
    }

    private void dealPage(Object oParams, BoundSql boundSql, Connection connection, MappedStatement mappedStatement, Map<String, Object> pMap, String sql) throws SQLException {
        ...
        PageEntity pageEntity = (PageEntity) (pMap.get("pageEntity"));
    ...
    private String appendFilterSql(List<FilterVo> filterList) {
